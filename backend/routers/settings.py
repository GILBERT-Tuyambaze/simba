...
async def get_settings(current_user: UserResponse = Depends(get_admin_user)):
    ...
    try:
        ...
        backend_descriptions = {
            ...
            "GROQ_API_KEY": "Groq API key for catalog assistant requests",
            "GROQ_MODEL": "Groq model name used for conversational search",
            "GROQ_BASE_URL": "Groq OpenAI-compatible API base URL",
            "APP_AI_BASE_URL": "OpenAI-compatible AI gateway base URL",
            "APP_AI_KEY": "OpenAI-compatible AI gateway API key",
            "OSS_SERVICE_URL": "Object storage service base URL",
            "OSS_API_KEY": "Object storage API key",
        ...
        frontend_descriptions = {
            ...
            "VITE_APP_TITLE": "Frontend application title",
            "VITE_APP_DESCRIPTION": "Frontend application description",
            "VITE_APP_LOGO_URL": "Frontend logo URL",
            ...
            "VITE_TWITTER_SITE": "Twitter/X site handle",
            "VITE_TWITTER_CREATOR": "Twitter/X creator handle",
        }

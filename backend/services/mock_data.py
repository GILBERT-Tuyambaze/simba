...
async def initialize_mock_data():
    ...
    available_dirs = [data_dir for data_dir in MOCK_DATA_DIRS if data_dir.exists()]
    if not available_dirs:
        logger.info("No mock data directories found; skipping mock initialization")
        return

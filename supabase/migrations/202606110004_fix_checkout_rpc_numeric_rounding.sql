-- Fix checkout RPC runtime rounding when product price is double precision.
...
begin
  ...
  loop
    ...
    v_line_price := round((v_product.price::numeric * (1 - coalesce(v_product.discount, 0)::numeric / 100)), 2);

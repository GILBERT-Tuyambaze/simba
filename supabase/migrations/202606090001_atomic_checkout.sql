-- Atomic checkout placement for Simba.
-- Keeps product pricing, inventory validation, order creation, order items, and
-- stock decrement in one PostgreSQL transaction.

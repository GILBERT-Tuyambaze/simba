                  ...
                  {[
                    {
                      ...
                      body: 'Branch managers and staff should see only their own store scope. Keep filters and RLS policies aligned.',
                    },
                    {
                      icon: Activity,
                      title: 'Authenticated access',
                      body: 'Dashboard access is tied to Supabase Auth and database row level security.',
                    },
                    {
                      icon: Shield,
                      title: 'Audit-ready actions',
                      body: 'Promotions, inventory, status changes, and refunds should be logged through Supabase audit fields.',
                    },
                  ].map((item) => {
                    const Icon = item.icon;
                    return (
